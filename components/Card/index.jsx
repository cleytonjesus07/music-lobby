...
export default function Card({ title, desc, cover, onClick }) {
    return (
        <div onClick={onClick} className="bg-gradient-to-b from-neutral-800 to-neutral-900  h-60 w-[20%] max-w-[100px] min-w-[calc(200px)] max-sm:w-[100%] px-2 py-3 flex flex-col rounded-md card hover:to-neutral-700 hover:from-neutral-700 transition-all m-2 cursor-pointer">
